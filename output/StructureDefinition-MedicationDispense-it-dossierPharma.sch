...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense">
      <sch:assert test="count(f:extension[@url = 'https://example.org/fhir/StructureDefinition/Recorded']) &gt;= 1">extension with URL = 'https://example.org/fhir/StructureDefinition/Recorded': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://example.org/fhir/StructureDefinition/Recorded']) &lt;= 1">extension with URL = 'https://example.org/fhir/StructureDefinition/Recorded': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:subject/f:identifier</sch:title>
  ...
  <sch:pattern>
    <sch:title>MedicationDispense.subject.identifier.extension</sch:title>
    <sch:rule context="f:MedicationDispense/f:subject/f:identifier/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.subject.identifier.use</sch:title>
    <sch:rule context="f:MedicationDispense/f:subject/f:identifier/f:use">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.subject.identifier.type</sch:title>
    <sch:rule context="f:MedicationDispense/f:subject/f:identifier/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.subject.identifier.system</sch:title>
    <sch:rule context="f:MedicationDispense/f:subject/f:identifier/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.subject.identifier.value</sch:title>
    <sch:rule context="f:MedicationDispense/f:subject/f:identifier/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.subject.identifier.period</sch:title>
    <sch:rule context="f:MedicationDispense/f:subject/f:identifier/f:period">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.subject.identifier.assigner</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:performer/f:actor/f:identifier</sch:title>
  ...
  <sch:pattern>
    <sch:title>MedicationDispense.performer.actor.identifier.extension</sch:title>
    <sch:rule context="f:MedicationDispense/f:performer/f:actor/f:identifier/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.performer.actor.identifier.use</sch:title>
    <sch:rule context="f:MedicationDispense/f:performer/f:actor/f:identifier/f:use">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.performer.actor.identifier.type</sch:title>
    <sch:rule context="f:MedicationDispense/f:performer/f:actor/f:identifier/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.performer.actor.identifier.system</sch:title>
    <sch:rule context="f:MedicationDispense/f:performer/f:actor/f:identifier/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.performer.actor.identifier.value</sch:title>
    <sch:rule context="f:MedicationDispense/f:performer/f:actor/f:identifier/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.performer.actor.identifier.period</sch:title>
    <sch:rule context="f:MedicationDispense/f:performer/f:actor/f:identifier/f:period">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.performer.actor.identifier.assigner</sch:title>
