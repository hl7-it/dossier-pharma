...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      <sch:assert test="count(f:extension[@url = 'https://example.org/fhir/StructureDefinition/MedicoTitolare']) &gt;= 1">extension with URL = 'https://example.org/fhir/StructureDefinition/MedicoTitolare': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://example.org/fhir/StructureDefinition/MedicoTitolare']) &lt;= 1">extension with URL = 'https://example.org/fhir/StructureDefinition/MedicoTitolare': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationRequest/f:subject/f:identifier</sch:title>
  ...
  <sch:pattern>
    <sch:title>MedicationRequest.subject.identifier.extension</sch:title>
    <sch:rule context="f:MedicationRequest/f:subject/f:identifier/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.subject.identifier.use</sch:title>
    <sch:rule context="f:MedicationRequest/f:subject/f:identifier/f:use">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.subject.identifier.type</sch:title>
    <sch:rule context="f:MedicationRequest/f:subject/f:identifier/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.subject.identifier.system</sch:title>
    <sch:rule context="f:MedicationRequest/f:subject/f:identifier/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.subject.identifier.value</sch:title>
    <sch:rule context="f:MedicationRequest/f:subject/f:identifier/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.subject.identifier.period</sch:title>
    <sch:rule context="f:MedicationRequest/f:subject/f:identifier/f:period">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.subject.identifier.assigner</sch:title>
