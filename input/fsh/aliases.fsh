...
Alias: CS_unitaTerritoriali = https://terminology.hl7.it/site/sid/istat-unitaAmministrativeTerritoriali
Alias: CS_Estero = https://terminology.hl7.it/site/sid/istat-unitaAmministrativeTerritorialiEstere

Alias: CS_ProfessioniIstat = https://terminology.hl7.it/site/CodeSystem/istat-professioni
Alias: CS_TitoloStudioIstat = https://terminology.hl7.it/site/CodeSystem/istat-ctsi03

Alias: V3ActStatus = http://terminology.hl7.org/CodeSystem/v3-ActStatus
Alias: CS_tipoEntita = https://terminology.hl7.it/site/CodeSystem/it-tipoEntita


Alias: $minsan-fls = https://terminology.hl7.it/site/sid/minsan-fls
Alias: $minsan-hsp = https://terminology.hl7.it/site/sid/minsan-hsp
Alias: $minsan-ria = https://terminology.hl7.it/site/sid/minsan-ria // https://www.salute.gov.it/portale/documentazione/p6_2_2_1.jsp?lingua=italiano&id=1053

Alias: $minsan-farmacie = https://terminology.hl7.it/site/sid/minsan-farmacie
Alias: $minsan-minsan-parafarmacie = https://terminology.hl7.it/site/sid/minsan-parafarmacie

Alias: $minsan-regione = https://terminology.hl7.it/site/sid/minsan-regione
//Alias: $v3-RoleCode = http://terminology.hl7.org/CodeSystem/v3-RoleCode
//Alias: $it-v3RoleCode = https://terminology.hl7.it/site/CodeSystem/it-v3RoleCode
...
Alias: $istat-unitaAmministrativeTerritoriali = https://terminology.hl7.it/site/sid/istat-unitaAmministrativeTerritoriali
...
//Alias: $aic = https://terminology.hl7.it/site/CodeSystem/aifa-aic TODO: complete the code system in terminology
Alias: $aic = http://hl7.it/fhir/dossierPharma/CodeSystem/aifa-aic
Alias: $gruppo-equivalenza = https://terminology.hl7.it/site/CodeSystem/aifa-ge
...
//Alias: $vs-aic = https://terminology.hl7.it/site/ValueSet/aifa-aic 
...
//Alias: $vs-gruppo-equivalenza = https://terminology.hl7.it/site/ValueSet/aifa-ge //TODO: this VS doesn't exist in terminology
// for fixing the error i define it in this guide
Alias: $vs-atc = https://terminology.hl7.it/site/ValueSet/who-atc
Alias: $vs-icd9cm = https://terminology.hl7.it/site/ValueSet/who-icd9cm
//Alias: $vs-aifa-nota = https://terminology.hl7.it/site/ValueSet/aifa-nota TODO: insert into terminology, there is in in dossier-pharma
...
//Alias: $aifa-nota = https://terminology.hl7.it/site/CodeSystem/aifa-nota TODO:
