...
pandoc %in_dir%\metodologia.docx -t commonmark -f docx -o %pub_dir%\methodology.md
pandoc %in_dir%\design.docx -t commonmark -f docx -o %pub_dir%\design.md
pandoc %in_dir%\copyright.docx -t commonmark -f docx -o %pub_dir%\copyright.md
fart %pub_dir%\index.md media/image home-
fart %pub_dir%\methodology.md media/image method-
fart %pub_dir%\design.md media/image design-
